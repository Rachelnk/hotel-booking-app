    ...
    <form className="flex flex-col gap-5" onSubmit={onSubmit}>
      ...
      <div className="flex flex-col md:flex-row gap-5">
        <label className="text-gray-700 text-sm font-bold">
          First Name
          {/* ...register - spreading the function's properties e.g onSumbit onClick */}
        ...
        <span>
          <button type="submit" className="bg-blue-600 text-white p-2 font-bold hover:bg-blue-500 text-1 ">
            Create Account
          </button>
        </span>
